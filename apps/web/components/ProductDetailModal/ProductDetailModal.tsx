  ...
  return (
    <Modal open={open} onClose={onClose}>
      <Box sx={{
        ...
        {/* Title */}
        <Typography variant="h5" sx={{ fontWeight: 'bold', color: 'rgb(0, 28, 100)', mb: 1 }}>
          {product.name}
        </Typography>

        {/* Price */}
        <Typography variant="h4" sx={{ color: 'rgb(29, 54, 120)', fontWeight: 'bold', mb: 2 }}>
        ...
        {/* Description */}
        <Typography variant="body1" sx={{ color: 'rgb(76, 98, 153)', mb: 3, lineHeight: 1.8 }}>
          {product.description}
        </Typography>
